...
(function($) { 
	var divContentImage = $("#header .box-image .box-content");
	divContentImage.empty();
	divContentImage.attr("style","background-color:#087eb6");
	divContentImage.append(imgpreload);
	var divContentImage = $("#header .box-image .box-content").attr("style","background-color:#087eb6");
/*
